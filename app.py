...
with tab2:
    ...
    # ── 9. STOK LAPAK ──────────────────────────────────────────────────────
    # [CHANGE] Ditempatkan DI LUAR blok if/else df_penjualan di atas, supaya
    # Stok Lapak tetap tampil walau tidak ada transaksi penjualan pada periode
    # yang dipilih (stok tidak terikat pada filter tanggal, sheetnya tidak
    # punya kolom tanggal).
